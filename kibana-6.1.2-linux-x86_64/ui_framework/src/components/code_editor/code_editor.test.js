  ...
  describe('behavior', () => {
    ...
    describe('hint element', () => {
      ...
      test('should be disabled when the ui ace box gains focus', () => {
        ...
        hint.simulate('keydown', { keyCode: _services.keyCodes.ENTER });
    ...
    describe('interaction', () => {
      ...
      test('pressing escape in ace textbox will enable overlay', () => {
        ...
        expect(component.find('[data-test-subj="codeEditorHint"]').matchesElement(document.activeElement)).toBe(true);
      });
    });
  });
});
