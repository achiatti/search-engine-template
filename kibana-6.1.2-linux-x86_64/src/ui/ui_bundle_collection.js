...
class UiBundleCollection {
  ...
  getInvalidBundles() {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        for (var _iterator3 = _this3.each[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
exports.default = UiBundleCollection;
